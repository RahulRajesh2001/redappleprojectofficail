...
const PageEleven = () => {
  return (
    <div className='bg-[#D9D9D9] relative   flex sm:flex-row vvsm:flex-col sm:justify-around vvsm:justify-center sm:gap-0 vvsm:gap-[30px] items-center w-[100%] sm:h-[250px] vvsm:h-[350px]'>
        <div>
            <div className='font-Forum font-normal text-[#000000] md:text-[32px] vvsm:text-[25px] '>Subscribe now and join the </div>
            <div className='font-Forum font-normal text-[#000000] md:text-[32px] vvsm:text-[25px]'>fashion-forward revolution!</div>
        </div>
...
<div className=' flex justify-center items-center absolute -bottom-[75px]  z-30 w-[150px] h-[150px]'>
        <img src={round} alt='' className='vsm:w-[130px] vsm:h-[130px] vvsm:w-[80px] vvsm:h-[80px]' />
        <img
          src={applelogo}
          alt=''
