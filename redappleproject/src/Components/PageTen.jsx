  ...
  return (
    <div className=' w-[100%] h-screen flex flex-col justify-center items-center'>
      ...
      <div className=' flex justify-center  sm:mb-[30px] sm:mt-0 vsm:mt-[20px] vvsm:mt-[10px]'>
        <img src={button} alt='' className='vsm:w-[220px] vsm:h-[50px] vvsm:w-[150px] vvsm:h-[40px] ' />
      </div>
...
{/* fifthpart */}
        <div className='fontAdd sm:text-[14px] vvsm:text-[10px] vsm:mt-[10px]'>Copyright &copy; redappleapparels.com  All Rights Reserved</div>
