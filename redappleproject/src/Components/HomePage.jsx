    ...
    <div>
      <div>
        <div className='w-full h-screen flex relative justify-center items-center'>
          ...
          >
            <p className='font-serif font-normal text-[#ffff] vsm:text-[30px]  sm:text-[45px] md:text-[65px] lg:text-[65px]'>Your One-Stop Shop</p>
            <p className='font-serif font-normal text-[#ffff] vsm:text-[30px]  sm:text-[45px] md:text-[65px] lg:text-[65px]'>for Wholesale Fashion</p>
          </div>
        </div>
      </div>
    </div>
