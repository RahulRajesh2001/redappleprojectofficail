      ...
      <div className=' sm:w-[15%]  sm:h-screen flex flex-col justify-center items-center  sm:border-t-2 sm:border-r-2 vsm:border-b-2 sm:border-b-0'>
       ...
       <div className=' overflow-auto sm:w-[45%] sm:h-screen flex flex-col items-center justify-around sm:border-t-2 
            ...
            <div className=' w-[70%] h-[25%] flex flex-col  justify-center'>
                   ...
                   <div className='font-Lora md:text-lg sm:text-[16px]   vsm:text-[13px]'>Your inner beauty reflects the way you are. Your inner health is as important as your outlook. Never Compromise on it.</div>
           ...
           <div className=' w-[70%] h-[25%]'>
                   ...
                   <div className='font-Lora md:text-lg sm:text-[16px]   vsm:text-[13px] '>Every top brand available in the market will be yours’ through Red Apple. The trust you rely upon those brands will be held tightly by us.</div>
            </div>
            <div className='w-[70%] h-[25%]'>
                   <div className='font-normal font-Poppins 
                                    lg:text-[30px]  lg:mb-[10px]
                                    ...
                                    '>Woven with Love</div>
                   <div className='font-Lora md:text-lg sm:text-[16px]  vsm:text-[13px]'>Enjoy your special days with heartful smiles woven out of love. We are very much alert to reach you premium goods.</div>
            </div> 
